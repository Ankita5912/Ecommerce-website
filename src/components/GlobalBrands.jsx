          ...
          <div className="relative w-full flex justify-center items-center">
            ...
            <div className="flex flex-row align-middle my-5  w-full h-72 transition-transform duration-500"
             style={{
              ...
              style={{ width: "calc(100% / 6)" }} // Show 3 cards at a time key={indx} 
              key={indx}>
                <img src={card.img} alt={card.Heading} className="h-52 w-full"></img>  
                <div className=" md:text-lg font-normal text-sm  tracking-tighte text-center">{card.Heading}</div>
                <div className=" font-bold text-gray-800 md:text-base text-sm uppercase tracking-tighter text-center">{card.discount}</div>
              </div>
              ))}  
